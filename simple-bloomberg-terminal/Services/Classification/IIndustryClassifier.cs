...
public interface IIndustryClassifier
{
    ...
    /// deterministically — so a fallback pick self-heals a wrong/missing source sector at the call site.</param>
    ...
    /// <param name="bypassCache">Skip the label cache for both READ and WRITE — always re-reason and don't
