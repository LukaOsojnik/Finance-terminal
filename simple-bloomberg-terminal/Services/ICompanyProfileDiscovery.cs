...
// GrossMargin (0–1) are best-effort ESTIMATES — flagged as such when stored.
...
/// nothing — the controller maps the result onto the create form for the user to review. Transport
