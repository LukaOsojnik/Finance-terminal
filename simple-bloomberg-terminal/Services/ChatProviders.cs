...
public static class ChatProviders
{
    ...
    /// first), the default when none is chosen, and where to get a key.</summary>
    public record ProviderInfo(
        ChatProviderId Id, string Display, string KeyLabel, string KeyHelpUrl,
        IReadOnlyList<string> Models, string DefaultModel);

    // Models current as of 2026-06. Most capable / default first.
